...
namespace Simulation
{
    ...
    public:
        ...
        static double dPp_f   (u_int const z, int const wl_, double const val) noexcept;
        static double dPp_b   (u_int const z, int const wl_, double const val) noexcept;
        static double dPs     (u_int const z, int const wl_, double const val) noexcept;
        static double dPASE_f (u_int const z, int const wl_, double const val) noexcept;
        static double dPASE_b (u_int const z, int const wl_, double const val) noexcept;
        ...
        void advance_signal_2 (u_int const z, double sign = 1.0) noexcept; //Advances 1 step the signal
        void advance_pump_f_2 (u_int const z, double sign = 1.0) noexcept; //Advances 1 step back pump
        void advance_pump_b_2 (u_int const z, double sign = 1.0) noexcept; //Advances 1 step forward pump
        void advance_ASE_f_2  (u_int const z, double sign = 1.0) noexcept; //Advances 1 step forward ASE
        void advance_ASE_b_2  (u_int const z, double sign = 1.0) noexcept; //Advances 1 step back ASE
        ////calculates all n in z and marches signal, pump and ASE to z+1
        void advance_step_2   (u_int const z, double const h, double const tol, u_int n_it) noexcept; 
        void regress_step_2(u_int const z, double const h, double const tol, u_int n_it) noexcept;
